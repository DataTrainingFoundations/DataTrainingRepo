...
| Data Analysis, Insights & End-User Relevance | 20% | Analysis answers questions, actionable insights, connects to personas/business needs (optionally via Streamlit or PowerBi dashboards) |
...
| Demo & Deliverables | 5% | End-to-end demo, clear objectives, dataset introduction, pipeline visualization (Snowflake UI, and/or Streamlit or PowerBi) |
